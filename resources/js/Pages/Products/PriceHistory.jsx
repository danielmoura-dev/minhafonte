...
export default function PriceHistory({ product, histories }) {
    return (
        <AppLayout title={`Histórico de preços — ${product.name}`}>
            ...
            <div className="flex items-center gap-4 mb-6">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-400">{product.name} · atual {formatCurrency(product.default_price)}</p>
                    </div>
                </div>
            </div>
